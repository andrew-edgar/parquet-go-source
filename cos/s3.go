...
//go:generate mockgen -destination=./mocks/mock_s3.go -package=mocks github.com/IBM/ibm-cos-sdk-go/service/s3/s3iface S3API
...
import (
	...
	"github.com/IBM/ibm-cos-skd-go/service/s3/s3manager"
